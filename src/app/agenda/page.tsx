...
export default function AgendaPage() {
  ...
  const fetchTrabajos = async () => {
    ...
    // Datos de prueba para ver el calendario
    const today = new Date()
    const fmt = (d: Date) => d.toISOString().split('T')[0]
    const testJobs: Trabajo[] = [
      { id: 'test-1', fecha_servicio: fmt(today), hora_servicio: '09:00', estado: 'proximo', prioridad: 'urgente', precio_acordado: 150, precio_cobrado: 0, cliente_id: '1', servicio_id: '1', notas_pre: '', notas_post: '', maquina_usada: '', presion_agua: '', quimicos_aplicados: '', es_recurrente: false, frecuencia_dias: null, materiales_utilizados: [], archivado: false, created_at: '', plan_recurrente_id: null, costo_lead: null, fecha_proximo_serv: null, completado_at: null, updated_at: '', clientes: { id: '1', nombre: 'Juan', apellido: 'López', direccion: '123 Main St', telefono: '555-0001' }, catalogo_servicios: { nombre: 'Lavado a Presión' } },
      { id: 'test-2', fecha_servicio: fmt(today), hora_servicio: '11:00', estado: 'proximo', prioridad: 'estandar', precio_acordado: 280, precio_cobrado: 0, cliente_id: '2', servicio_id: '2', notas_pre: '', notas_post: '', maquina_usada: '', presion_agua: '', quimicos_aplicados: '', es_recurrente: false, frecuencia_dias: null, materiales_utilizados: [], archivado: false, created_at: '', plan_recurrente_id: null, costo_lead: null, fecha_proximo_serv: null, completado_at: null, updated_at: '', clientes: { id: '2', nombre: 'María', apellido: 'Pérez', direccion: '456 Oak Ave', telefono: '555-0002' }, catalogo_servicios: { nombre: 'Epóxico Garaje' } },
      { id: 'test-3', fecha_servicio: fmt(today), hora_servicio: '14:00', estado: 'completado', prioridad: 'estandar', precio_acordado: 200, precio_cobrado: 200, cliente_id: '3', servicio_id: '3', notas_pre: '', notas_post: '', maquina_usada: '', presion_agua: '', quimicos_aplicados: '', es_recurrente: false, frecuencia_dias: null, materiales_utilizados: [], archivado: false, created_at: '', plan_recurrente_id: null, costo_lead: null, fecha_proximo_serv: null, completado_at: null, updated_at: '', clientes: { id: '3', nombre: 'Sofia', apellido: 'Martínez', direccion: '789 Pine Rd', telefono: '555-0003' }, catalogo_servicios: { nombre: 'Limpieza Ventanas' } },
      { id: 'test-4', fecha_servicio: fmt(new Date(today.getTime() + 86400000)), hora_servicio: '10:00', estado: 'proximo', prioridad: 'estandar', precio_acordado: 850, precio_cobrado: 0, cliente_id: '4', servicio_id: '4', notas_pre: '', notas_post: '', maquina_usada: '', presion_agua: '', quimicos_aplicados: '', es_recurrente: false, frecuencia_dias: null, materiales_utilizados: [], archivado: false, created_at: '', plan_recurrente_id: null, costo_lead: null, fecha_proximo_serv: null, completado_at: null, updated_at: '', clientes: { id: '4', nombre: 'Carlos', apellido: 'Gómez', direccion: '321 Elm St', telefono: '555-0004' }, catalogo_servicios: { nombre: 'Pintura Exterior' } },
      { id: 'test-5', fecha_servicio: fmt(new Date(today.getTime() + 86400000 * 2)), hora_servicio: '08:00', estado: 'proximo', prioridad: 'urgente', precio_acordado: 1200, precio_cobrado: 0, cliente_id: '5', servicio_id: '1', notas_pre: '', notas_post: '', maquina_usada: '', presion_agua: '', quimicos_aplicados: '', es_recurrente: false, frecuencia_dias: null, materiales_utilizados: [], archivado: false, created_at: '', plan_recurrente_id: null, costo_lead: null, fecha_proximo_serv: null, completado_at: null, updated_at: '', clientes: { id: '5', nombre: 'Laura', apellido: 'Díaz', direccion: '654 Maple Dr', telefono: '555-0005' }, catalogo_servicios: { nombre: 'Lavado a Presión - Driveway' } },
      { id: 'test-6', fecha_servicio: fmt(new Date(today.getTime() + 86400000 * 3)), hora_servicio: '15:00', estado: 'proximo', prioridad: 'baja', precio_acordado: 150, precio_cobrado: 0, cliente_id: '6', servicio_id: '2', notas_pre: '', notas_post: '', maquina_usada: '', presion_agua: '', quimicos_aplicados: '', es_recurrente: false, frecuencia_dias: null, materiales_utilizados: [], archivado: false, created_at: '', plan_recurrente_id: null, costo_lead: null, fecha_proximo_serv: null, completado_at: null, updated_at: '', clientes: { id: '6', nombre: 'Pedro', apellido: 'Ruiz', direccion: '987 Cedar Ln', telefono: '555-0006' }, catalogo_servicios: { nombre: 'Lavado a Presión durísimo' } },
      { id: 'test-7', fecha_servicio: fmt(new Date(today.getTime() + 86400000 * 5)), hora_servicio: '09:30', estado: 'proximo', prioridad: 'estandar', precio_acordado: 280, precio_cobrado: 0, cliente_id: '7', servicio_id: '3', notas_pre: '', notas_post: '', maquina_usada: '', presion_agua: '', quimicos_aplicados: '', es_recurrente: false, frecuencia_dias: null, materiales_utilizados: [], archivado: false, created_at: '', plan_recurrente_id: null, costo_lead: null, fecha_proximo_serv: null, completado_at: null, updated_at: '', clientes: { id: '7', nombre: 'Ana', apellido: 'Morales', direccion: '147 Birch Way', telefono: '555-0007' }, catalogo_servicios: { nombre: 'Lavado a Presión - Driveway' } },
    ]
    
    if (data && data.length > 0) {
      setTrabajos(data as Trabajo[])
    } else {
      setTrabajos(testJobs)
    }
    setLoading(false)
  }
