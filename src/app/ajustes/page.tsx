          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="hidden sm:block text-slate-300/80 text-base mt-1 font-medium">
        ...
        <div className="flex-1 md:overflow-y-auto md:min-h-0 pb-4 md:pb-2 space-y-3">
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-black uppercase tracking-wider text-slate-700">Foto de Perfil</h3>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-5">
              ...
              <div className="flex-1 space-y-3">
                ...
                <div className="flex gap-2">
                  <button 
                    onClick={() => fileInputRef.current?.click()}
                    className="flex items-center gap-1.5 h-10 px-4 rounded-xl bg-[#0097A7]/10 border border-[#0097A7]/20 text-[#0097A7] text-base font-bold hover:bg-[#0097A7]/20 transition-all cursor-pointer"
                  >
                    <Upload className="h-3 w-3" /> Subir Foto
                  </button>
                  <button 
                    onClick={resetToDefault}
                    className="flex items-center gap-1.5 h-10 px-4 rounded-xl bg-slate-100 border border-slate-200/60 text-slate-500 text-base font-bold hover:bg-slate-200 transition-all cursor-pointer"
                  >
            ...
            <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-base font-black uppercase tracking-wider text-slate-700">Ajustar Foto</h3>
                </div>
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-base font-black text-[#0097A7]">{Math.round(zoom * 100)}%</span>
                    </div>
                    <input 
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-base font-black text-[#0097A7]">{rotation}°</span>
                    </div>
                    <input 
                  ...
                  <div className="flex gap-2 pt-2">
                    <button 
                      ...
                      disabled={loading}
                      className="flex items-center gap-1.5 h-11 px-5 rounded-xl bg-gradient-to-r from-[#0097A7] to-[#00C9E0] text-white text-base font-black shadow-md shadow-cyan-500/20 hover:shadow-cyan-500/30 transition-all active:scale-[0.98] cursor-pointer disabled:opacity-50"
                    >
                    ...
                    <button 
                      ...
                      className="h-11 px-4 rounded-xl bg-slate-100 border border-slate-200/60 text-slate-500 text-base font-bold hover:bg-slate-200 transition-all cursor-pointer"
                    >
                      Cancelar
                    </button>
                  </div>
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-black uppercase tracking-wider text-slate-700">Notificaciones</h3>
            </div>
            ...
            <div className="space-y-2.5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 bg-slate-50/50 rounded-xl border border-slate-100/60">
                <div className="space-y-0.5">
                  <Label className="text-base font-bold text-slate-700">Sincronización con el Dispositivo</Label>
                  <p className="text-base text-slate-400">Activa el permiso en el navegador para recibir avisos.</p>
                </div>
                <NotificationManager />
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 bg-slate-50/50 rounded-xl border border-slate-100/60">
                <div className="space-y-0.5">
                  <Label className="text-base font-bold text-slate-700">Alertas de Stock</Label>
                  <p className="text-base text-slate-400">Notificación cuando un insumo llegue al nivel crítico.</p>
                </div>
                <Switch 
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-black uppercase tracking-wider text-slate-700">Información del Negocio</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input 
                  ...
                  className="h-11 text-base rounded-xl border-slate-200/60 bg-white focus:bg-white text-slate-800"
                />
              </div>
              <div className="space-y-1.5">
                <label className="text-base font-bold uppercase tracking-wider text-slate-500 flex items-center gap-1">
          ...
          <div className="bg-white border border-rose-200/60 rounded-2xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-black uppercase tracking-wider text-rose-700">Seguridad</h3>
            </div>
            <div className="flex flex-col sm:flex-row gap-2">
              <button 
                onClick={() => setShowPasswordModal(true)}
                className="flex items-center justify-center gap-1.5 h-11 px-5 rounded-xl bg-slate-100 border border-slate-200/60 text-slate-600 text-base font-bold hover:bg-slate-200 transition-all cursor-pointer"
              >
              ...
              <button 
                ...
                disabled={loading}
                className="flex items-center justify-center gap-1.5 h-11 px-5 rounded-xl bg-gradient-to-r from-rose-500 to-rose-600 text-white text-base font-black shadow-md shadow-rose-500/20 hover:shadow-rose-500/30 transition-all active:scale-[0.98] cursor-pointer disabled:opacity-50"
              >
          ...
          {/* Success Toast */}
          {saved && (
            <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200/60 rounded-xl p-3 text-emerald-600 text-base font-bold animate-in fade-in slide-in-from-bottom-2">
