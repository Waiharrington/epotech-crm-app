        ...
        <div className="flex-1 overflow-y-auto min-h-0 pb-24 md:pb-2 space-y-3">
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">Foto de Perfil</h3>
            </div>
            ...
            <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">Ajustar Foto</h3>
                </div>
                <button onClick={() => { setEditMode(false); setSelectedImg(null) }} className="h-7 w-7 rounded-lg flex items-center justify-center text-slate-400 hover:text-rose-500 hover:bg-rose-50 transition-all cursor-pointer">
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">Notificaciones</h3>
            </div>
          ...
          <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">Información del Negocio</h3>
            </div>
