          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <Button
                ...
                className="h-10 px-4 text-base font-bold rounded-xl bg-white/10 border-white/15 text-white hover:bg-rose-500/20 hover:border-rose-400/40 backdrop-blur-md transition-all active:scale-[0.98]"
              >
              ...
              <Button
                ...
                size="sm"
                className="h-10 px-4.5 text-base font-black rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white border-none shadow-md shadow-emerald-500/20 hover:shadow-emerald-500/30 transition-all active:scale-[0.98]"
              >
