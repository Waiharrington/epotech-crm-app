        ...
        <div className="relative z-10 flex flex-col gap-3 xl:gap-2.5">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div className="flex items-center gap-2.5">
              <div className="h-9 w-9 xl:h-8 xl:w-8 rounded-xl flex items-center justify-center bg-white/10 border border-white/15 backdrop-blur-md shadow-xs shrink-0">
                <Users className="h-4.5 w-4.5 xl:h-4 xl:w-4 text-[#00C9E0] filter drop-shadow-[0_0_8px_rgba(0,201,224,0.7)]" />
              </div>
              <div>
          ...
          <div className="relative pt-0.5 border-t border-white/[0.06]">
            ...
            <Input
              ...
              className="mt-2 pl-9 h-9 xl:h-8.5 text-[11px] xl:text-[10.5px] rounded-xl bg-white/[0.06] border-white/10 text-white placeholder:text-slate-400/70 backdrop-blur-md focus-visible:ring-[#00C9E0]/40 focus-visible:border-[#00C9E0]/40 transition-all"
              value={search}
        ...
        >
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center flex-1 min-h-64 gap-3">
              ...
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Cargando clientes</p>
            </div>
              ...
              <table className="w-full border-collapse">
                <thead className="sticky top-0 z-10">
                  <tr className="bg-slate-50/95 backdrop-blur-sm">
                    <th className="text-left px-3.5 xl:px-3 py-2 text-[8.5px] xl:text-[8px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Cliente</th>
                    <th className="hidden md:table-cell text-left px-3.5 xl:px-3 py-2 text-[8.5px] xl:text-[8px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Teléfono</th>
                    <th className="hidden sm:table-cell text-left px-3.5 xl:px-3 py-2 text-[8.5px] xl:text-[8px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Ciudad</th>
                    <th className="hidden md:table-cell text-left px-3.5 xl:px-3 py-2 text-[8.5px] xl:text-[8px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Tipo</th>
                    <th className="text-right px-3.5 xl:px-3 py-2 text-[8.5px] xl:text-[8px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Acciones</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredClientes.map((cliente) => (
                    ...
                    >
                      <td className="px-3.5 xl:px-3 py-2 xl:py-1.5">
                        <div className="flex items-center gap-2.5 min-w-0">
                          <div className="h-7 w-7 xl:h-6.5 xl:w-6.5 rounded-xl flex items-center justify-center bg-gradient-to-tr from-[#E6F9FB] to-[#E6F9FB]/60 border border-[#0097A7]/10 shadow-xs group-hover:shadow-[0_0_8px_rgba(0,201,224,0.25)] group-hover:border-[#0097A7]/30 transition-all shrink-0">
                            <span className="text-[9px] xl:text-[8.5px] font-black text-[#0097A7]">
                              {getInitials(cliente.nombre, cliente.apellido)}
                            </span>
                          </div>
                          <div className="flex flex-col min-w-0">
                            <span className="text-[11px] xl:text-[10.5px] font-bold text-slate-800 truncate group-hover:text-[#0097A7] transition-colors">
                              {cliente.nombre} {cliente.apellido}
                            </span>
                            <span className="text-[9px] text-slate-400 font-medium md:hidden flex items-center gap-1">
                      ...
                      <td className="hidden md:table-cell px-3.5 xl:px-3 py-2 xl:py-1.5 text-[10.5px] xl:text-[10px] font-medium text-slate-600 tabular-nums">
                        {cliente.telefono}
                      </td>
                      <td className="hidden sm:table-cell px-3.5 xl:px-3 py-2 xl:py-1.5">
                        <div className="flex items-center gap-1 text-[10.5px] xl:text-[10px] font-medium text-slate-500">
                      ...
                      <td className="hidden md:table-cell px-3.5 xl:px-3 py-2 xl:py-1.5">
                        <Badge
                          className={
                            cliente.tipo_propiedad === 'comercial'
                              ? 'h-5 px-2 rounded-lg text-[8.5px] font-black uppercase tracking-wider border bg-gradient-to-tr from-[#E6F9FB] to-[#E6F9FB]/60 text-[#0097A7] border-[#0097A7]/20 shadow-none'
                              : 'h-5 px-2 rounded-lg text-[8.5px] font-black uppercase tracking-wider border bg-slate-50 text-slate-500 border-slate-200/80 shadow-none'
                          }
                        >
                          {cliente.tipo_propiedad === 'comercial' ? 'Comercial' : 'Residencial'}
                        </Badge>
                      </td>
                      <td className="px-3.5 xl:px-3 py-2 xl:py-1.5" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex flex-col items-center justify-center flex-1 min-h-64 text-center p-6">
              ...
              <h3 className="text-sm font-bold text-slate-800 tracking-tight">No se encontraron clientes</h3>
              ...
              <Button
                onClick={() => setShowWizard(true)}
                size="sm"
                className="mt-4 h-8 px-3.5 text-[10px] font-black rounded-xl bg-gradient-to-r from-[#00C9E0] to-[#0097A7] hover:from-[#00b4ca] hover:to-[#035bb3] text-white border-none shadow-md shadow-cyan-500/20 transition-all duration-300 active:scale-[0.98]"
              >
                <Plus className="mr-1.5 h-3.5 w-3.5" />
                Nuevo Cliente
              </Button>
