        ...
        <div className="relative z-10 flex flex-col gap-3 xl:gap-2.5">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-slate-300/80 text-[11px] xl:text-[11px] 2xl:text-xs mt-0.5 font-medium">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <Button
                ...
                size="sm"
                className="flex-1 md:flex-none h-8 xl:h-7.5 px-3.5 text-xs xl:text-[11px] font-black rounded-xl bg-gradient-to-r from-[#00C9E0] to-[#0097A7] hover:from-[#00b4ca] hover:to-[#035bb3] text-white border-none shadow-md shadow-cyan-500/20 hover:shadow-cyan-500/30 transition-all duration-300 active:scale-[0.98]"
              >
          ...
          <div className="relative pt-0.5 border-t border-white/[0.06]">
            ...
            <Input
              ...
              className="mt-2 pl-9 h-9 xl:h-8.5 text-[13px] xl:text-[10.5px] rounded-xl bg-white/[0.06] border-white/10 text-white placeholder:text-slate-400/70 backdrop-blur-md focus-visible:ring-[#00C9E0]/40 focus-visible:border-[#00C9E0]/40 transition-all"
              value={search}
        ...
        >
          ...
          <div className="bg-gradient-to-r from-[#030b17] via-[#0B1E3F] to-[#030b17] px-3.5 xl:px-3 py-2.5 xl:py-2 flex items-center justify-between shrink-0 shadow-[inset_0_-1px_0_rgba(255,255,255,0.08)]">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xs xl:text-[11px] font-black text-white uppercase tracking-[0.15em]">
                Listado de Clientes
              </h2>
            </div>
          ...
          {loading ? (
              ...
              <table className="w-full border-collapse">
                <thead className="sticky top-0 z-10">
                  <tr className="bg-slate-50/95 backdrop-blur-sm">
                    <th className="text-left px-3.5 xl:px-3 py-2 text-[10px] xl:text-[10px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Cliente</th>
                    <th className="hidden md:table-cell text-left px-3.5 xl:px-3 py-2 text-[10px] xl:text-[10px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Teléfono</th>
                    <th className="hidden sm:table-cell text-left px-3.5 xl:px-3 py-2 text-[10px] xl:text-[10px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Ciudad</th>
                    <th className="hidden md:table-cell text-left px-3.5 xl:px-3 py-2 text-[10px] xl:text-[10px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Tipo</th>
                    <th className="text-right px-3.5 xl:px-3 py-2 text-[10px] xl:text-[10px] font-extrabold text-slate-400 uppercase tracking-wider border-b border-slate-100">Acciones</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredClientes.map((cliente) => (
                    ...
                    >
                      ...
                      <td className="hidden md:table-cell px-3.5 xl:px-3 py-2 xl:py-1.5 text-[10.5px] xl:text-xs font-medium text-slate-600 tabular-nums">
                        {cliente.telefono}
                      </td>
                      <td className="hidden sm:table-cell px-3.5 xl:px-3 py-2 xl:py-1.5">
                        <div className="flex items-center gap-1 text-[10.5px] xl:text-xs font-medium text-slate-500">
                        ...
                        <Badge
                          className={
                            cliente.tipo_propiedad === 'comercial'
                              ? 'h-5 px-2 rounded-lg text-[10px] font-black uppercase tracking-wider border bg-gradient-to-tr from-[#E6F9FB] to-[#E6F9FB]/60 text-[#0097A7] border-[#0097A7]/20 shadow-none'
                              : 'h-5 px-2 rounded-lg text-[10px] font-black uppercase tracking-wider border bg-slate-50 text-slate-500 border-slate-200/80 shadow-none'
                          }
                        >
            ...
            <div className="flex flex-col items-center justify-center flex-1 min-h-64 text-center p-6">
              ...
              <Button
                onClick={() => setShowWizard(true)}
                size="sm"
                className="mt-4 h-8 px-3.5 text-xs font-black rounded-xl bg-gradient-to-r from-[#00C9E0] to-[#0097A7] hover:from-[#00b4ca] hover:to-[#035bb3] text-white border-none shadow-md shadow-cyan-500/20 transition-all duration-300 active:scale-[0.98]"
              >
                <Plus className="mr-1.5 h-3.5 w-3.5" />
                Nuevo Cliente
              </Button>
