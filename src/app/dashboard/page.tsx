    ...
    if (isMobileDevice) {
      ...
      if (saved) {
        try {
          ...
          setT1Delay(typeof parsed.t1Delay === 'number' && !isNaN(parsed.t1Delay) && parsed.t1Delay > 0 ? parsed.t1Delay : 800)
          setT2Delay(typeof parsed.t2Delay === 'number' && !isNaN(parsed.t2Delay) && parsed.t2Delay > 0 ? parsed.t2Delay : 1800)
          setT3Delay(typeof parsed.t3Delay === 'number' && !isNaN(parsed.t3Delay) && parsed.t3Delay > 0 ? parsed.t3Delay : 3800)
          setT4Delay(typeof parsed.t4Delay === 'number' && !isNaN(parsed.t4Delay) && parsed.t4Delay > 0 ? parsed.t4Delay : 4600)
        } catch (e) {
          setNozzleX(20.0)
          setNozzleY(33.0)
          setTargetXPct(0.33)
