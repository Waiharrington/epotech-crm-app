              ...
              <div className="bg-amber-50 border border-amber-200/60 rounded-2xl p-4 relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row gap-3 items-start justify-between">
                  ...
                  <button 
                    ...
                    className="flex items-center gap-1.5 h-11 px-4 rounded-lg bg-amber-100 border border-amber-200/60 text-amber-800 text-base font-bold hover:bg-amber-200 transition-colors shrink-0 cursor-pointer w-full md:w-auto justify-center md:justify-start"
                  >
        ...
        <div className="flex gap-3 items-start min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {!reminder.completado && (
                <span className={cn("text-[10px] font-black uppercase px-1.5 py-0.5 rounded-md border", config.badge)}>
                  {config.label}
                </span>
              )}
            </div>
            ...
            {reminder.descripcion && (
              <p className={cn(
                "text-[13px] mt-1.5 leading-relaxed truncate max-w-2xl",
            ...
            <div className="flex flex-wrap items-center gap-3 mt-2.5">
              ...
              {reminder.notificado && !reminder.completado && (
                <span className="text-[10px] font-black uppercase px-1.5 py-0.5 rounded-md bg-blue-50 text-blue-600 border border-blue-200/60">
                  Notificado
                </span>
              )}
            </div>
