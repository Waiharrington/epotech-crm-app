  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <aside className={cn(
        ...
        <div className={cn(
          ...
          <div className="relative group/toggle z-30">
            <button
              ...
              className="p-2 rounded-xl bg-slate-800/80 hover:bg-[#00C9E0]/20 border border-slate-700/60 hover:border-[#00C9E0]/50 text-slate-300 hover:text-[#00C9E0] transition-all duration-300 shadow-md group active:scale-95"
          ...
          {!isCollapsed ? (
            <>
              <img 
                ...
                className="h-14 w-auto object-contain relative z-10 logo-premium mt-2" 
              />
              {/* Accent line + tagline */}
        ...
        <nav className="flex-1 px-2.5 py-4 space-y-4 overflow-visible no-scrollbar">
          <div>
            {!isCollapsed && (
        ...
        {/* Logout Footer */}
        <div className="border-t border-sidebar-border px-3 py-4 animate-sidebar-item relative group/logout" style={{ animationDelay: `${(mainNavItems.length + moreNavItems.length) * 50}ms` }}>
          <button
